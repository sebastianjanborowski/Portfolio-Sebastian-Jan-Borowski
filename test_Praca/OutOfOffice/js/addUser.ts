...
but?.addEventListener('click', () => {
    const Full_Name_object = document.getElementById('Full_Name') as HTMLInputElement;
    const Subdivision_object = document.getElementById('Subdivision') as HTMLInputElement;
    const Position_object = document.getElementById('Position') as HTMLInputElement;
    const People_Partner_object = document.getElementById('People_Partner') as HTMLInputElement;
    const Out_of_Balance_object = document.getElementById('Out_of_Balance') as HTMLInputElement;
