...
<head>
    ...
    <title>Handmadetree-czas i koszt dostawy</title>
    ...
    <meta name="keywords" content="Handmade TreePL-czas i koszt dostawy">
    <meta name="title" content="Handmadetree-czas i koszt dostawy">
...
<body>
    <header>
        <nav class="navbar navbar-dark bg-jumpers navbar-expand-lg sticky" >
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#mainmenu" aria-controls="mainmenu" aria-expanded="false" aria-label="Przełącznik nawigacji">
                <img src="img/przycisk.avif" height="30px" width="40px" alt="Menu button">
            </button>
    ...
    <section class="container-fluid  men title pod od odd ">
        <h1 class="czas czcionka_p"> Czas i koszt dostawy</h1>
    </section>
        <section class="container-fluid  men title  odd ">
            <div class="row">
                <div class="col-lg-4 col-md-12 odd">
                   

                    <h5 class="margines czas_i_koszt_dostawy czcionka">Polska:</h5>
                    <div class="czcionka_p wielkosc">
                            <p class="margines">Czas wysyłki to około 1-2 dni robocze.
                            Paczkomat lub kurier InPost.</p>
                            <p class="margines">Koszt wysyłki zależy od gabaryty całej paczki:</p>                                                        
                            <p class="margines">W zamówieniach powyżej 1000zł - darmowa dostawa- kurier.</p> 
                            <p class="margines">Odbiór osobisty – Bezpłatny (Piaseczno)</p>  
                            <p class="margines">Zamówienia wysyłane są po zaksięgowaniu całej płatności na koncie bankowym.</p>  
                            <p class="margines">Płatność za pobraniem - tak- dotyczy jedynie gotowych drzewek będących aktualną ofertą sklepu.</p>
                            <p class="margines">Indywidualne  projekty opłacane są w całości przed wysyłką.</p> 
                            <p class="margines">Więcej informacji w dziale "zaprojektuj własne drzewko"</p>
                    </div>
           
                </div>

                <div class="col-lg-4 col-md-12  odd wielkosc">
                   <h5 class="czcionka">Europa:</h5> 
                   <div class="czcionka_p">
                    <p>Kurier TNT.</p>
                    <p> Czas wysyłki to około 4-5dni roboczych.</p>
                    <p>Cena wysyłki zależy od wielkości drzewka i kraju, do którego jest wysyłane drzewko.</p>
                    <p>Zamówienia wysyłane są po zaksięgowaniu całej płatności na koncie bankowym.</p>
                    <p>Płatność za pobraniem - ze względu na to że jest to przesyłka zagraniczna nie oferuję takiej opcji.</p>
                    
                   </div>
                   
                </div>
                <div class="col-lg-4 col-md-12 wielkosc">
                    <h5 class="czcionka">USA:</h5>
                    <p class="margines2"> Kurier TNT.</p>
                    <p class="margines2">Czas wysyłki to około 5-7dni roboczych.</p>
                    <p class="margines2">Cena wysyłki zależy od wielkości drzewka i stanu, do którego jest wysyłane drzewko.</p>
                    <p class="margines2">Zamówienia wysyłane są po zaksięgowaniu całej płatności na koncie bankowym.</p>
                    <p class="margines2">Płatność za pobraniem - ze względu na to że jest to przesyłka zagraniczna nie oferuję takiej opcji.</p>
                </div>
            </div>
        ...
        <section class="container-fluid " style="margin-top: 3%;">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="czas czcionka_p">Cennik Dostaw InPost</h1>
                    <table class="table czcionka_p ">
                        <tr>
                            <td class="komurka bialy"></td>
                            <td class="komurka czarny">Paczkomat:</td>
                            <td class="komurka bialy">Kurier:</td>
                        </tr>
                        <tr>
                            <td class="komurka czarny">Gabaryt A</td>
                            <td class="komurka bialy">17 zł</td>
                            <td class="komurka czarny">20 zł</td>
                        </tr>
                        <tr>
                            <td class="komurka bialy">Gabaryt B</td>
                            <td class="komurka czarny">19 zł</td>
                            <td class="komurka bialy">21 zł</td>
                        </tr>
                        <tr>
                            <td class="komurka czarny">Gabaryt C</td>
                            <td class="komurka bialy">21 zł</td>
                            <td class="komurka czarny">26 zł</td>
                        </tr>
                    </table>
                </div>
            </div>
