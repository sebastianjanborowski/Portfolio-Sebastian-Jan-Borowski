    ...
    <section class="container-fluid margines1 r">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="error">
                <?php
                if(isset($_SESSION['emialWystepuje']))
                {
                ...
                <div class="container mt-5">
                    ...
                    <div class="col-lg-12 marginesCheck">
                        <span class="wymaganeDane">Pola wymagane *</span><br/>
                        <span class="span">*</span>
                         <input type="checkbox" class="checkbox" id="checkbox0" > 
                          Zapoznałem się i akceptuję <a class="a" href="http://localhost/SerwisBeckendowyHandmadetree.pl/regulamin_sklepu.php">regulamin sklepu</a>  i  <a class="a" href="http://localhost/SerwisBeckendowyHandmadetree.pl/polityka_prywatnosci.php">polityką prywatności</a>.  <br/>

                          <span class="span">*</span>
                           <input type="checkbox" class="checkbox" id="checkbox1" required>
                            Dokończ rejestrację w <a class="a" href="http://localhost/SerwisBeckendowyHandmadetree.pl/moje_konto.php">Moje konto</a>  – Ustawienia lub podczas zakupu pierwszego produktu.  <br/>
