...
<head>
    ...
    <title>Handmadetree-zwroty i reklamacje</title>
    ...
    <meta name="keywords" content="Handmade TreePL-zwroty i reklamacje">
    <meta name="title" content="Handmadetree-zwroty i reklamacje">
...
<body>
    ...
    <div style="width: 100%; border-top:1px solid rgb(255, 255, 255); opacity: 0.2; margin-bottom: 2%; margin-top: 10%;"></div>

    <section class="container-fluid Zwroty">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="czcionka  h">Zwroty, Wymiany i Anulowanie zamówienia. </h1>
            </div>
        </div>
    </section>
    <div style="width: 100%; border-top:1px solid black; opacity: 0.2; margin-bottom: 2%; margin-top: 2%;"></div>
    <section class="container-fluid odstep2">
        <div class="row">
            <div class="col-lg-6">
                <h4 class="czcionka">Projekty Indywidualne, personalizowane:</h4>
                <p class="czcionka_p p">Ze względu na indywidualny charakter zamówienia, nie mogę przyjmować zwrotów ani wymiany na produkty personalizowane, chyba że są one uszkodzone lub wadliwe z mojej winy. </p>
                <h4 class="czcionka">Uszkodzone lub Wadliwe Przedmioty:</h4>
                <p class="czcionka_p p">Jeśli Twój przedmiot dotrze uszkodzony lub wadliwy, proszę o kontakt w ciągu 48 godzin od dostawy ze zdjęciami przedmiotu i opakowania. Zorganizuję wymianę produktu lub zwrot pieniędzy. </p>
            </div>
            <div class="col-lg-6">
                <h4 class="czcionka">Produkty Niepersonalizowane:</h4>
                <p class="czcionka_p p">Zwroty i wymiany są akceptowane w ciągu 14 dni od dostawy. Przedmioty muszą być w oryginalnym stanie, opakowaniu, starannie zapakowane tak by nie zostały uszkodzone podczas transportu. Kupujący są odpowiedzialni za koszty wysyłki zwrotnej. </p>
                <h4 class="czcionka">Anulowanie zamówienia:</h4>
                <p class="czcionka_p p">jest akceptowane w ciągu 24 godzin od zakupu. Po tym okresie, mogę już rozpocząć pracę nad Twoim zamówieniem, co utrudnia jego anulowanie oraz powoduje poniesione przeze mnie koszty.</p>
            </div>
        </div>
    </section>
