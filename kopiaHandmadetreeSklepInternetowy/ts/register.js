...
id_Button.addEventListener("click", () => {
    ...
    const passwordOne_id = document.getElementById("passwordOne");
    const passwordTwo_id = document.getElementById("passwordTwo");
    const regulamin_id = document.getElementById("checkbox0");
    const koniecRejestracji_id = document.getElementById("checkbox1");
    const id_checkbox2 = document.getElementById("checkbox2");
    let error = "";
    // Zbierz wartości
    const email = email_id.value;
    const passwordOne = passwordOne_id.value;
    const passwordTwo = passwordTwo_id.value;
