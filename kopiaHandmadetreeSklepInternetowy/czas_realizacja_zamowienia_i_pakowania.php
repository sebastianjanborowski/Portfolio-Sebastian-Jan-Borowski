...
<head>
    ...
    <title>Handmadetree-czas realizacja zamowienia i pakowania</title>
    ...
    <meta name="keywords" content="Pakowanie rękodzieła, inpost wysyłka, personalizowany produkt, grawerowanie, gips">
    <meta name="title" content="Handmadetree-czas realizacja zamowienia i pakowania">
    ...
    <link rel="icon" href="img/logo_upgrade.png" type="image/png" alt="Logo icon">
    <link rel="stylesheet" href="css/style.css"/>
...
<body>
    ...
    <section class="container-fluid  men title od">
        <div class="row">
            <div class="col-lg-3 col-md-12  order-lg-1 order-sm-1 wf">
                <h2 class="czcionka">Czas Realizacji</h2>
                <div class="czcionka_p">
                    <p>Zrobione, gotowe do wysyłki drzewko:</p>
                    <p>Czas przygotowania gotowego drzewka do wysyłki plus czas operacyjny to około 2 dni robocze od zaksięgowania płatności na koncie.</p>
                    <p>Cały proces pakowania można zobaczyć na filmiku poniżej.</p>
                    
                    <div class="embed-responsive embed-responsive-16by9 hide-on-desktop">
                        <iframe title="Sprawdź, jak pakujemy drzewka na YouTube" alt="Sprawdź, jak pakujemy drzewka na YouTube" title="Sprawdź, jak pakujemy drzewka na YouTube" class="embed-responsive-item" style="border-radius: 20px;" src="https://www.youtube.com/embed/roCPkVkrE1o" allowfullscreen></iframe>
                    </div>
                </div>
            </div>

            <div class="col-lg-5 col-md-12  order-sm-4 order-lg-3">
                <h2 class="czcionka">Indywidualny projekt:</h2> 
                <div class="czcionka_p wf">
                    <p>Szybkość realizacji indywidualnego projektu zależy od następujących czynników:</p>
                    <p><b>Materiały</b>: Czas realizacji zamówienia może się różnić w zależności od dostępności materiałów wykorzystywanych do projektu. W przypadku, gdy materiały są dostępne od ręki, czas ten może być krótszy. Jednakże w przypadku, gdy wymagane są specjalne zamówienia- dużej ilość drutu w określonym kolorze, specjalna doniczka - czas realizacji może się wydłużyć przez co należy doliczyć okres oczekiwania na dostawę materiałów. Na szybkość realizacji zamówienia ma również wpływ użyty materiał w projekcie: żywica epoksydowa, gips, beton. Materiały te potrzebują określoną ilość czasu by wyschnąć.</p>
                    <p><b>Dodatki</b>: Jeśli zamówienie wymaga określonych dodatków lub personalizacji, czas realizacji może się wydłużyć. Dodatki mogą obejmować np. specjalne wykończenia, grawerowanie czy też inne formy dostosowania produktu do indywidualnych preferencji klienta.</p>
                    <p><b>Złożoność Projektu</b>: Czas realizacji zamówienia może być również uzależniony od złożoności samego projektu. Im bardziej skomplikowany projekt, tym więcej czasu może być potrzebne do jego wykonania. Projekty wymagające szczegółowego planowania, skomplikowane konstrukcje, wielkość drzewka, gęstość liści mogą wymagać dodatkowego czasu.</p>
                    <p>Wszystkie te czynniki są uwzględniane podczas ustalania terminu realizacji zamówienia. Moim celem jest zapewnienie najdokładniejszych informacji na temat oczekiwanego czasu realizacji i dostawy.  </p>
                </div>
            </div>

            <section class="order-sm-3 col-lg-1 col-md-12">
                <div class="embed-responsive embed-responsive-16by9 ">
                    <iframe alt="Proces pakowania zamówienia" class="xd embed-responsive-item" style="border-radius: 20px;" src="https://www.youtube.com/embed/roCPkVkrE1o" allowfullscreen></iframe>
                </div>
            </section>

            <div class="col-lg-4 col-md-12 order-sm-2  order-lg-2 wf">
                <h2 class="czcionka">Pakowanie: Zamówienia</h2>
                <div class="czcionka_p">
                <p>Dbałość o Bezpieczeństwo i Estetykę.</p>
                <p>Podczas przygotowywania drzewka do wysyłki, bardzo zwracam uwagę na staranne zabezpieczenie wszystkich elementów.</p>
                <p>Na samym początku wybieram odpowiedni, gruby, wielowarstwowy karton, który zapewnia bezpieczny transport.</p>
                <p>Samo drzewko spinam plastikowymi opaskami zaciskowymi (trytytki), które można z łatwością odpiąć nożyczkami, cążkami lub kombinerkami z ostrą końcówką.</p>
                <p>Drzewko starannie owijam w folię bąbelkową, która zapewnia dodatkową warstwę ochrony przed wstrząsami i uszkodzeniami mechanicznymi. </p>
                <p>Używam ekologicznych wypełniaczy typu “chrupki”. Umieszczone są w opakowaniu, aby zapobiec przesuwaniu się podczas transportu. </p>
                <p>Karton oklejam naklejkami ostrzegawczymi.</p>
                <p>Dodatkowo do każdej paczki dołączam: mały unikatowy upominek, historię drzewka, naklejkę firmową i podziękowanie za zakupy.</p>
            </div>
            </div>
        </div>
    </section>
