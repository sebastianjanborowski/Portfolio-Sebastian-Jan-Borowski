...
<header>
    ...
    <div class="col-lg-12">
        <h2 class="h2">Logowanie w Handmade Tree </h2>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="obramowanieDolne">
                    ...
                    <form action="logowanieWithFacebook.php">
                    ...
                    <form action="logowanieWithGoogle.php">
                ...
                <div class="container mt-5">
                    ...
                    <div id="error" class="error"></div>
                            ...
                            <button class="button" id="button">Zaloguj się</button>
                            
                </div>
                
                   <a class="ResetPassword" href="resetPassword.php">Odzyskiwanie utraconego hasła</a><br/>
                ...
                <p>Otrzymuj informacje o nowościach oraz wyprzedarzach</p>

            </div>
            <div class="col-lg-6">
                <div class="wysrodkowanieZaloguj">
                <h3>Dlaczego warto mieć konto na HandmadeTree?</h3>
                <p class="zarejestrujSie">Zarejestruj się, by skorzystać z licznych dodatkowych przywilejów.</p>
                <ul class="listaUl">
                    <li>Otrzymasz rabat na pierwsze zakupy.</li>
                    <li>Zbieraj punkty lojalnościowe i wymieniaj na nowe zniżki (złote liście).</li>
                    <li>Kolejne zakupy bez potrzeby wprowadzania danych.</li>
                    <li>Historia zamówień.</li>
                    <li>i wiele innych...</li>
                </ul>
                <p class="zarejestrujSie">Jeżeli nie masz konta kliknij przycisk zarejestruj sie.</p>
                <a class="rejestracjaLogowanie" href="rejestracja.php">Zarejestruj się</a>
                </div>
            </div>
