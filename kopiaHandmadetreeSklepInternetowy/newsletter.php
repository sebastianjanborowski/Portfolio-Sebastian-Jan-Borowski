...
<body>
    ...
    <div  style="width: 100%; border-top:1px solid black; opacity: 0.2; margin-bottom: 9%;margin-top: 2%;"></div>
    ...
    <section class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="form">
                    <h2>NewsLetter</h2>
                    <span class="pP">Śledz aktualności,promocje i termminy warsztaatów w Handadetree.</span><br/>
                    <span class="pP">Zapisz sie teraz i uzyskaj 10% rabatu na pierwsze zakupy.</span><br/>


                    <input type="email"  id="email" placeholder="Wprowadź swój e-mail"><br/>
                
                    <button id="button" class="button">Zapisz się</button>
                    <div class="wyniki">
