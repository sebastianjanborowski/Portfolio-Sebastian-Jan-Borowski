...
<head>
    ...
    <title>Handmadetree-regulamin sklepu</title>
    <meta name="description" content="Sklep artystyczny z ręcznie robionymi Drzewkami Bonsai">
    <meta name="keywords" content="Drzewka Bonsai, rzeźby, aranżacje wnętrz">
    <meta name="title" content="Handmadetree-regulamin sklepu">
    ...
    <link rel="stylesheet" href="css/regulamin_sklepu.css"/>
...
<body>
    ...
    <section class="container-fluid bialy">
        <div class="row">
            <div class="col-lg-12">
                <img alt="Baner" class="img-fluid x" loading="lazy" src="img/baner.jpg" alt="Baner">
            </div>
            <div class="col-md-12 xxx regulaminsklepu">
                <img alt="Baner mobile" loading="lazy" src="img/baner_mobile.jpg" class="img-fluid rounded-img xx margines" alt="Baner-mobile">
            </div>
        </div>
    ...
    <section class="container ">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="czcionka_p h2">Ta podstrona jest w trakcie budowy. </h2>
                <h2 class="czcionka_p h2 p"> Już wkrótce wielkie otwarcie sklepu internetowego!</h2>
               <p class="czcionka_p wielkosc p">Jeśli masz pytania lub chcesz dowiedzieć się więcej, proszę o <a class="a" alt="Skontaktuj się z Handmade Tree" title="Skontaktuj się z Handmade Tree" href="kontakt.php">kontakt:)</a>  </p>
               <p class="czcionka_p wielkosc p">Część informacji takie jak: czas dostawy, formy płatnośći zawarta jest w dziale</p>
                <p class="p"><a class="a" alt="Zapoznaj się z naszą polityką prywatności" title="Zapoznaj się z naszą polityką prywatności" href="polityka_prywatnosci.php">polityka prywatności.</a></p>
            </div>
    ...
    <button class="messenger-button" style="color:#3b5998; background-color: transparent;" alt="Skontaktuj się z Handmade Tree" title="Skontaktuj się z Handmade Tree"> <a target="_blank" alt="Skontaktuj się z Handmade Tree" href="https://m.me/100000738468369"><i class="fab fa-facebook-messenger"></i></a>  </button>
