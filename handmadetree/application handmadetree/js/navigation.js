...
const showNewsletter = "showNewsletter";
...
const showNewsletter_id = document.getElementById(showNewsletter);
...
const source_showNewsletter = "../templates/showNewsletter.php";
...
if(showNewsletter_id)
{
    showNewsletter_id.addEventListener("click",() =>{
        window.location.href = source_showNewsletter;
    })
}
