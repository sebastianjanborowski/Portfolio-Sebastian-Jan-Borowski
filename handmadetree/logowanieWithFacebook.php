...
if (isset($_SESSION['username']) && isset($_SESSION['email'])) {
    ...
    header('Location: calculations/logowanieFacebook.php');
    exit();
}
...
if (isset($_GET['code'])) {
    ...
    $loginUrl = $helper->getLoginUrl('http://localhost/SerwisBeckendowyHandmadetree.pl/logowanieWithFacebook.php', $permissions);
