...
<head>
    ...
    <title>Handmadetree-moje konto</title>
    ...
    <meta name="keywords" content="Handmadetree-moje konto">
    <meta name="title" content="Handmadetree-moje konto">
...
<body>
    ...
    <section class="container-fluid m">
        <div class="col-md-12 ">
            <img alt="Baner" src="img/baner_etsy.jpg" class="img-fluid baner-img baner-img-mobile rounded-img" alt="Baner">
        </div>
       
        </section>
        
        <div class="col-md-12 rodzicc">
            <img alt="Baner mobilny" src="img/baner_mobile.jpg" class="img-fluid baner-img baner_mobile  rounded-img wff" alt="Baner">
        </div>

        <div class="jeden"  style="width: 100%; border-top:1px solid black; opacity: 0.2; margin-bottom: 2%; margin-top: -6%;"></div>

        <section class="container-fluid ">
            <div class="row">
                <div class="col-md-12 ">
                    <h3 class="czcionka_p rodzic">Ta podstrona jest w trakcie budowy.</h3>
                    <p class="czcionka_p rodzic">Już wkrótce wielkie otwarcie! </p>
                    <p class="czcionka_p rodzic">Jeśli masz pytania lub chcesz dowiedzieć się więcej, proszę <a class="a" alt="Skontaktuj się z Handmade Tree" title="Skontaktuj się z Handmade Tree" href="kontakt.php">kontakt:)</a>  </p>
                </div>
            </div>
    ...
    <div  style="width: 100%; border-top:1px solid black; opacity: 0.2; margin-bottom:2%;"></div>
