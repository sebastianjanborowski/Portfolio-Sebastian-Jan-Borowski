...
<head>
    ...
    <title>Handmadetree-formy płatności</title>
    ...
    <meta name="keywords" content="Handmadetree-formy płatności">
    <meta name="title" content="Handmadetree-formy płatności">
...
<body>
    ...
    <section class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <img alt="Baner" class="img-fluid x marginFPIR" loading="lazy" src="img/baner.jpg">
            </div>
            <div class="col-md-12 marginFPIR">
                <img alt="Baner mobilny" src="img/baner_mobile.jpg" loading="lazy" class="img-fluid rounded-img xx margines" alt="Baner">
            </div>
        </div>
        
    </section>

    <section class="container-fluid wf marginTop">
        <div class="row">
            <div class="col-lg-12">
                <h2 class="czcionka_p h2">Formy Płatności i Raty.</h2>
            </div>
            <div class="row p">
                <div class="col-lg-6">
                    <p class="czcionka_p font">Płatność przez stronę Handmade TreePL
                        Aktualnie akceptuję następujące formy płatności elektronicznej: Blik na telefon, PayPal, przelew na konto bankowe.
                    </p>

                    <p class="czcionka_p font">W przypadku gotowego oraz robionego na specjalne zamówienie drzewka płatność wymagana jest w momencie zakupu.
                    </p>

                    <p class="czcionka_p font">Po zaksięgowaniu wpłaty na koncie bankowym zamówienie przekierowane jest do realizacji oraz wysyłki.

                    </p>
                </div>
                <div class="col-lg-6">
                    <p class="czcionka_p font">Raty: Aktualnie jest możliwość rozłożenia płatności na dwa miesiące, raty po ½ wartości wliczając cenę Bonsai i wysyłki.
                    </p>

                    <p class="czcionka_p font">Drzewko wysyłam po wpłaceniu drugiej raty. 
                    </p>

                    <p class="czcionka_p font">Jeśli masz pytania lub chcesz dowiedzieć się więcej, proszę o <a alt="Skontaktuj się z Handmade Tree" title="Skontaktuj się z Handmade Tree" class="a" href="kontakt.php">kontakt:)</a> 
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid minusLewo">
        <div class="row">
    ...
    <section class="container-fluid malo2 y">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12" style="letter-spacing: 2px;">
    ...
    <button title="Skontaktuj się z Handmade Tree" class="messenger-button" style="background-color: #3b5998; background-color: transparent;" alt="Skontaktuj się z Handmade Tree" title="Messenger-button"> <a target="_blank" alt="Skontaktuj się z Handmade Tree"  href="https://m.me/100000738468369"><i class="fab fa-facebook-messenger"></i></a>  </button>
