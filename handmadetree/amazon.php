...
<head>
    ...
    <title>Handmadetree-Amazon</title>
    <meta name="description" content="Zapraszamy do Handmade Tree!, Sklep z ręcznie robionymi Drzewkami Bonsai, Zapisz się na warsztaty z rękodzieła w Warszawie, Idealne dekoracje do wnętrz i wyjątkowe prezenty, Odkryj piękno rękodzieła i zainspiruj się naszymi unikalnymi produktami">
    <meta name="keywords" content="Zapraszamy do Handmade Tree!, Sklep z ręcznie robionymi Drzewkami Bonsai, Zapisz się na warsztaty z rękodzieła w Warszawie, Idealne dekoracje do wnętrz i wyjątkowe prezenty, Odkryj piękno rękodzieła i zainspiruj się naszymi unikalnymi produktami">
    <meta name="author" content="Michał">
    <meta name="title" content="Handmadetree-Amazon">
...
<body>
    <header>
        <nav class="navbar navbar-dark bg-jumpers navbar-expand-lg sticky">
            <a class="navbar-brand" href="index.php" alt="Przejdź na stronę główną"> <img class="logo" src="img/logo_upgrade.png" alt="Logo image"> </a>
    ...
    <section class="container-fluid odstep2222">
        <div class="col-md-12 ">
            <img alt="Zdjęcie baner wersja na komputer" loading="lazy" src="img/baner_etsy.jpg" class="img-fluid baner-img baner-img-mobile rounded-img" alt="Baner">
        </div>
       
        </section>
        <div class="col-md-12 odstep2222">
            <img alt="Zdjęcie baner wersja mobilna" loading="lazy" src="img/baner_mobile.jpg" class="img-fluid baner-img baner_mobile  rounded-img wff" alt="Baner">
        </div>
        ...
        <section class="container">
            <div class="row">
                <div class="col-md-12 ">
                    <h3 class="czcionka_p">Sklep na Amazon jest w trakcie budowy. </h3>
                    <p class="czcionka_p">Już wkrótce wielkie otwarcie! </p>
                    <p class="czcionka_p">Jeśli masz pytania lub chcesz dowiedzieć się więcej, proszę <a alt="Skontaktuj się z Handmade Tree" href="kontakt.php">kontakt:)</a>  </p>
                    <p class="czcionka_p"> Zapraszam Cię do otwartego sklepu na Etsy, gdzie możesz zobaczyć aktualną ofertę. </p>
                    <p class="czcionka_h  lece2">
                        <a alt="Sprawdź ofertę specjalną na drzewka bonsai w Sklepie Etsy" class="link2" href="http://handmadetreepl.etsy.com/" target="_blank">KUP Drzewko na Etsy!</a>
                   </p>
                </div>
            </div>
    ...
    <section class="container-fluid malo2 y">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 leter czcionka_p">
                <p style="font-size: 2.5vh;" class="malo koniec">&copy; 2024 Wszelkie prawa zastrzeżone. </p>
                <p style="font-size: 2.5vh;" class="malo koniec"> Sklep artystyczny  z ręcznie robionymi Drzewkami  Bonsai.</p>
            </div>
        </div>
    </section>
    ...
    <button title="Skontaktuj się z Handmade Tree" class="messenger-button" style="background-color: transparent;" alt="Skontaktuj się z Handmade Tree" title="Messenger-button"> <a target="_blank"  href="https://m.me/100000738468369"><i class="fab fa-facebook-messenger"></i></a>  </button>
