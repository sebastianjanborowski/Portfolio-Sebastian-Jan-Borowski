...
<head>
    ...
    <meta name="title" content="Handmadetree-Rejestracja">
...
<header>
    ...
    <div style="width: 100%; border-top:1px solid black; opacity: 0.2; margin-bottom: 3%;margin-top: 3%;"></div>


    <div class="col-lg-12">
        <h2 class="h2">Rejestracja konta Handmade Tree </h2>
    </div>
    <section class="container-fluid margines1 r">
       
        <div class="row">
            <div class="col-lg-6">
                <div class="obramowanieDolne">
                    <h3>kontunuj z...</h3>
                    
                    <form action="loginWithFacebook.php">
                        
                           <button type="submit" class="facebook"> 
                                <i class="fab fa-facebook fejsbuk"></i>
                                    Rejestracja poprzez Facebook
                           </button>
                    </form>
                    
                    <form action="loginWithGoogle.php">
                        <button type="submit" class="google"> 
                            <i class="fab fa-google google-icon"></i>
                                Rejestracja poprzez Google
                        </button>
                    </form>
                </div>    
                <div class="error">
                <?php
                    echo $_SESSION['emialWystepuje'];
                    unset($_SESSION['emialWystepuje']);
                ?>
                </div>
                <div class="container mt-5">
                    <!-- E-mail -->
                    <div class="row mb-3 align-items-center">
                        <div class="col-sm-4 font-size">
                            E-mail
                        </div>
                        <div class="col-sm-8">
                    ...
                    <div class="row mb-3 align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="password" class="input" id="passwordOne" name="passwordOne" minlength="8" required>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="password" class="input" id="passwordTwo" name="passwordTwo" minlength="8" required>
                        </div>
                    </div>
                    <div class="col-lg-12 marginesCheck">
                        <span class="wymaganeDane">Pola wymagane z tym znakiem * są wymagane</span><br/>
                         <input type="checkbox" class="checkbox" id="checkbox0" > 
                          Zapoznałem się i akceptuję <a class="a" href="http://localhost/SerwisBeckendowyHandmadetree.pl/regulamin_sklepu.php">regulamin sklepu</a>  i  <a class="a" href="http://localhost/SerwisBeckendowyHandmadetree.pl/polityka_prywatnosci.php">polityką prywatności</a>. <span class="span">*</span> <br/>
          
                           <input type="checkbox" class="checkbox" id="checkbox1" required>
                          Dokończ rejestrację w <a class="a" href="http://localhost/SerwisBeckendowyHandmadetree.pl/moje_konto.php">Moje konto</a>  – Ustawienia lub podczas zakupu pierwszego produktu. <span class="span">*</span> <br/>
                      
                          <input type="checkbox" class="checkbox checkbox2" id="checkbox2">
                          Zapisz się do Newsletter i bądź na bieżąco z nowymi promocjami oraz warsztatami z rękodzieła.
                      </div>
            ...
            <div class="col-lg-6">
                <img class="img-fluid photoRejestracja" src="img/rejestracjaPhoto.jpg" alt="Złote drzewko bonsai, anielskie dekoracje, doniczka ceramiczna">
            </div>
    ...
    <div class="col-lg-12">
        <h2 class="h3">Dokończ rejestracje w Moje konto-Ustawienia</h2>
    </div>
    <div  style="width: 100%; border-top:1px solid black; opacity: 0.2; margin-bottom: 3%;margin-top: 2%;"></div>
    ...
    <section class="container-fluid malo2 y">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <p style="letter-spacing: 2px; font-size: 3vh;" class="malo koniec">&copy; 2024 Wszelkie prawa zastrzeżone. </p>
                <p style="letter-spacing: 2px; font-size: 3vh;" class="malo koniec"> Sklep artystyczny  z ręcznie robionymi Drzewkami  Bonsai.</p>
            </div>
        </div>
    </section>
   ...
   <script src="ts/register.js"></script>
