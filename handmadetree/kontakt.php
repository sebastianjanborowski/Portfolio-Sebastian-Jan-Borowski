...
<head>
    ...
    <title>Handmadetree-kontakt</title>
    ...
    <meta name="keywords" content="Handmade TreePL, prezenty okolicznościowe, Piaseczno, NIP 123 115 5447, Jasińskiego,  884273209">
    <meta name="title" content="Handmadetree-kontakt">
...
<body>
    ...
    <section class="container  men title pod od ">
        <div class="row">
            <div class="col-lg-7 col-md-12 col-sm-12 order-sm-1 na col-xs-12">
               <img alt="Zdjęcie kontaktowe" class="img-fluid rounded-img tlo" loading="lazy" src="img/aktualny_kontakt.jpg">
               <h1 class="nah czcionka">Masz Pytania?</h1>
               <p class="nap czcionka_p">Pisz do mnie śmiało lub zadzwoń po więcej informacji</p>
               <p class="nad czcionka_p">Dane kontaktowe Firmy:</p>
               <p class="nam czcionka_p"><i class="fas fa-building kf"></i> Michał Matracki Handmade TreePL</p>
               <p class="nau czcionka_p"><i class="fas fa-map-marker-alt kl"></i> ul. Gen Jaśinskiego 7/13</p>
               <p class="nae czcionka_p"> <i class="fas fa-mail-bulk kp"></i> 05-500 Piaseczno (koło Warszawy)</p>
               <p class="naP czcionka_p"><i class="fas fa-id-card kn"></i> NIP: 123 115 5447</p>
               <p class="nar czcionka_p"><i class="fas fa-id-card"></i> REGON: 527 402 584</p>
               <p class="nat czcionka_p"><i class="fas fa-phone kt"></i> tel.<a alt="Kliknij, aby zadzwonić: 884 273 209" title="Kliknij, aby zadzwonić: 884 273 209" target="_blank" class="tel" href="tel:+48884273209"> +48 884 273 209</a></p>
               <p class="nao czcionka_p"><i class="fas fa-envelope km"></i> Email: handmadetreepl@gmail.com</p>
               <p class="nas czcionka_p"><i class="fas fa-store ks"></i> Sklep: <a alt="Sprawdź ofertę specjalną na drzewka bonsai w Sklepie Etsy" title="Sprawdź ofertę specjalną na drzewka bonsai w Sklepie Etsy" class="sklep" target="_blank" href="https://handmadetreepl.etsy.com"> Etsy</a></p>
            </div>          

            <div class="col-lg-5 col-md-12 col-sm-12 order-sm-2 custom-col">  
                <!-- Osadzone iframe -->
                <div>
                    <iframe alt="Lokalizacja na mapie" title="Lokalizacja na mapie" class="r mapa" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2452.5263877646057!2d21.019704!3d52.0701469!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47192f8fded58c29%3A0x17db218f6179341b!2sHandmade%20TreePL%20R%C4%99kodzie%C5%82o%20Artystyczne!5e0!3m2!1spl!2spl!4v1710145409594!5m2!1spl!2spl" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </section>
