"use strict";
const przyciskk = document.getElementById('button');
przyciskk === null || przyciskk === void 0 ? void 0 : przyciskk.addEventListener('click', () => {
    const Project_Type_object = document.getElementById('Project_Type');
    ...
    const Project_Manager_object = document.getElementById('Project_Manager');
    const Status_object = document.getElementById('Status');
    if (Project_Type_object && Start_Date_object && End_Date_object && Status_object && Comment_object && Project_Manager_object) {
        ...
        if (Project_Type.length > 0) {
            const url = "http://localhost/test_Praca/OutOfOffice/calculations/addProject.php";
            const formData = {
